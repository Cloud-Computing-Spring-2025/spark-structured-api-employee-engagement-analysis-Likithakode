...
def main():
    ...
    input_file = "/workspaces/spark-structured-api-employee-engagement-analysis-Likithakode/input/employee_data.csv"
    output_file = "/workspaces/spark-structured-api-employee-engagement-analysis-Likithakode/outputs/task3/engagement_levels_job_titles.csv"
